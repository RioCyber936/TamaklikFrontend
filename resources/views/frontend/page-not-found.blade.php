...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Page not found - Homess</title>
    ...
    <body>
        ...
        <![endif]-->
          ...
          <header>
            <div id="header-sticky" class="header-area">
                <div class="header pl-30 pr-30 pt-45 pb-45">
                    <div class="container-fluid">
                        <div class="row align-items-center justify-content-lg-between position-relative">
                                   ...
                                   <nav id="mobile-menu">
                                        <ul class="d-block">
                                            ...
                                            <li class="full-mega-menu-position"><a href="shop.html">Shop</a>
                                                <ul class="mega-menu full-mega-menu pb-40 pl-50 pt-60 border-gray bg-white" data-background="images/bg/background_menu.jpg">
                                            ...
                                            <li class="full-mega-menu-position"><a href="blog-right-sidebar.html">Blog</a>
                                                <ul class="mega-menu full-mega-menu full-mega-menu2 border-gray pb-40 pl-50 pt-60" data-background=">">
                                                    <li class="border-r-light-gray pl-10">
                            ...
                            <div class="col-xl-2  col-lg-2 col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center">
                                <div class="logo">
                                    <a href="index.html" class="d-block" data-toggle="tooltip" data-selector="true" data-placement="bottom" title="Homess"><img src="images/logo/logo.png" alt="HOMESS"></a>
                                </div>
                            </div><!-- /col -->
                            <div class="col-xl-5  col-lg-5 col-md-4 col-sm-4 col-4">
                                <div class="header-right d-flex justify-content-end align-items-center">
                                    <ul class="header-login d-none d-lg-block">
                                        <li><a href="login.html" data-toggle="tooltip" data-selector="true" data-placement="bottom" title="Login / Register"><span class="icon-users"></span><span class="logo-register ml-2">Login / Register</span></a></li>
                                    </ul>
                                    <ul class="header-search d-none d-lg-block">
                                        <li><span class="icon-search"></span></li>
                                    </ul>
                                    <ul class="header-heart d-none d-lg-block">
                                        <li><a href="wishlist.html" data-toggle="tooltip" data-selector="true" data-placement="bottom" title="View wishlist"><span class="icon-heart"></span></a></li>
                                    </ul>
                                    <ul>
                                                ...
                                                <div class="h-shop-cart-contetn over-x-heddne over-y-scroll">
                                                    <ul class="d-flex pb-20 border-b-light-gray">
                                                        <li class="h-shop-cart-img pl-0">   
                                                            <a class="d-block" href="product-details.html"><img src="images/product/product1.jpg" alt=""></a>
                                                        </li>
                                                        <li class="pl-3">
                ...
                <div class="container-wrapper extra-padding-15 border-b-light-gray pb-100">
                    <div class="row">
                        <div class="col-xl-8  col-lg-12  col-md-12  col-sm-12 col-12 offset-xl-2">
                            <div class="banner-404 pt-105 pl-60 pr-60">
                                <div class="img-404">
                                    <img src="images/bg/404.jpg" alt="">
                                </div>
                                <div class="text-404 text-center pt-60">
                                    <h3 class="pb-25">Error. We can’t find the page you’re looking for.</h3>
                                    ...
                                    <a href="index.html" class="sub-btn d-inline-block text-white theme-bg border-0 mt-45 text-uppercase">back to home page</a>
                                </div>
                            </div>
                        </div><!-- /col -->
                    </div><!-- /row -->
        ...
        <!-- ====== footer-area-start ============================================ -->
        <footer>
            <div class="footer-area-area footer2 footer6 theme-bg">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-2  col-lg-2  col-md-3  col-sm-6 col-12 mt-40">
                                <div class="footer-widget">
                                    <h6 class="footer-title text-uppercase mb-40 text-white">My Account</h6>
                                    <ul>
                            ...
                            <div class="col-xl-2  col-lg-2  col-md-3  col-sm-6 col-12 mt-40">
                                <div class="footer-widget">
                                    <h6 class="footer-title text-uppercase mb-40 text-white">Information</h6>
                                    <ul>
                            ...
                            <div class="col-xl-2  col-lg-2  col-md-3  col-sm-6 col-12 mt-40">
                                <div class="footer-widget">
                                    <h6 class="footer-title text-uppercase mb-40 text-white">Customer Service</h6>
                                    <ul>
                            ...
                            <div class="col-xl-4  col-lg-4  col-md-12  col-sm-12 col-12 mt-40">
                                <div class="footer-widget footer-6-about text-lg-right mr-100 mr-lg-0">
                                    <h6 class="footer-title text-uppercase mb-40 text-white">About us</h6>
                                    <p>Siemon & Salazar is a premium theme with advanced admin module. It’s extremely customizable, easy to use and fully responsive and retina ready.</p>
                                    <div class="payment mt-60 mb-15">
                                        <img src="images/logo/payment1.png" alt="">
                                    </div>
                                </div><!-- /footer-widget -->
                            </div><!-- /col -->
                        </div><!-- /row -->
                    ...
                    <div class="container-wrapper extra-padding-15">
                        <div class="copyright-area pt-35 pb-35 border-t-light-dark">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-xl-12  col-lg-12  col-md-12  col-sm-12 col-12 d-md-flex align-items-center justify-content-between">
                                    <div class="copyright-text">
                                        ...
                                        <p class="pr-1">Copyright ©
                                            <a href="#">Homess</a>
                                            All Rights Reserved. Powered by <a href="#">Bluesky Themes</a></p>
                                    </div>
                                    <ul class="social-link d-flex align-items-center text-center mt-15 mb-15">
